  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
       ...
       <li><a href="http://localhost/Restaurent%20System/admin/add.php"><span class="fas fa-qrcode"></span> DASHBOARD</a></li>
...
<table class="table" style="margin-top: 20px">
   <tr>
    ...
    $sql = "SELECT  reserve_id, no_of_guest, email, phone, date_res, time, suggestions   from  reservation ";
    $result = $conn-> query($sql);

    if ($result-> num_rows > 0) {
        while($row = $result-> fetch_assoc()){ 
            echo "<tr><td>". $row["reserve_id"] ."</td><td>". $row["no_of_guest"] ."</td><td>". $row["email"] ."</td><td>". $row["phone"] ."</td><td>". $row["date_res"] ."</td><td>". $row["time"] ."</td><td>". $row["suggestions"] ."</td></tr>";
    }
    echo "</table>";
}
else{
