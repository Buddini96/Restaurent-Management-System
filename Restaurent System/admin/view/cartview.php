    ...
    <header id="header">
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          <a href="index.php" class="navbar-brand">
              <h3 class="px-5">
                  <i class="fas fa-shopping-basket"></i> Shopping Cart - View
              </h3>
          </a>
    ...
    <section class="section-4">
        ...
        <div class="col-md-4 col-12 text-center">
            <div class="card mr-2 d-inline-block shadow-lg">
                ...
                <div class="card-body">
                  ...
                  <a href="mainview.php" class="text-secondary text-decoration-none">Main Dishes</a>
                ...
                <div class="carousel-inner text-center">
                  <div class="carousel-item active">
                    <div class="card mr-2 d-inline-block shadow">
                      ...
                      We know your taste !  
                        ...
                        <a href="pizzaview.php" class="text-secondary text-decoration-none">Pizza</a>
                  ...
                  <div class="carousel-item">
                    ...
                    We know your taste !  
                        ...
                        <a href="appeview.php" class="text-secondary text-decoration-none">Appetizers</a>
        ...
        <div class="col-md-4 col-12 text-center">
            <div class="card mr-2 d-inline-block shadow-lg">
                ...
                <div class="card-body">
                  ...
                  <a href="drinkview.php" class="text-secondary text-decoration-none">Drinks</a>
        ...
        <div class="col-md-4 col-12 text-center">
            <div class="card mr-2 d-inline-block shadow-lg">
                ...
                <div class="card-body">
                  ...
                  <a href="kidview.php" class="text-secondary text-decoration-none">Kids special</a>
                ...
                <div class="carousel-inner text-center">
                  <div class="carousel-item active">
                    ...
                    We know your taste ! 
                        ...
                        <a href="dessertview.php" class="text-secondary text-decoration-none">Desserts</a>
      ...
      <div class="col-md-4 col-12 text-center">
            <div class="card mr-2 d-inline-block shadow-lg">
                ...
                <div class="card-body">
                  <h3 class="card-title">Today's Spcial</h3>
                  <p class="card-text">
                  HungryManiya Menu Special  <br>
                    We know your taste !               
                  </p>
                  <a href="todayview.php" class="text-secondary text-decoration-none">Today's Spcial</a>
