...
<head>
	...
	<body>
			...
			<section>
				<div class="reg_img">
					...
					<div class="box2">
						...
						<h1 style="text-align: center; font-size: 25px; color: #ccffff;"><i>New customer Registration </i></h1>
			...
			<?php
				...
				{
					$count=0;
					$sql="SELECT username, password from `customer`";		/* not allowed to enter same type user name */
					...
					if($count==0)								/* Registration details enter into the data base */ 
						{
							...
							mysqli_query($db,"INSERT INTO `customer` VALUES('', '$firstname', '$lastname', '$username', '$password', '$email', '$contact ');");
