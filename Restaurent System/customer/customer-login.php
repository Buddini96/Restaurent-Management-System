	...
	<body>
			<section id="sec2">
				<div class="log_img">
					...
					<div class="box1">
						...
						<h1 style="text-align: center; font-size: 25px; color: white;">Customer Login </h1><br>
						...
						<form name="login" action="" method="post">
							...
							<p style="color: white; padding-left: 15px;">
								<br>
								<a style="color: red;" href="update_password.php"><b>Forgot Password...?</b></a> &nbsp; &nbsp; &nbsp; &nbsp; Are you new member..? &nbsp; &nbsp; &nbsp; &nbsp;<a style="color: yellow;" href="c-registration.php">Sign Up </a>
							</p>
					</div>
			...
			<?php 
				...
				if(isset($_POST['submit']))
				{
					...
					$res=mysqli_query($db,"SELECT * FROM `customer` WHERE username='$username' && password='$password' ;");
					...
					else
					{
						...
						?>
							<script type="text/javascript">
								window.location="http://localhost/Restaurent%20System/cushome.php#" 		/* after logged user is here  */
							</script>
						<?php 
					}
				}
