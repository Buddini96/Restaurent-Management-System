...
<body>  
        ...
        <ul class="nav navbar-nav">
            <li class=""><a href="http://localhost/Restaurent%20System/customer/Shopping_cart/main%20cart/index.php"><i class="fas fa-shopping-basket"></i>Menu</a></li>
        <ul class="nav navbar-nav">  
            ...
            <li><a href="http://localhost/Restaurent%20System/customer/Shopping_cart/main%20cart/index.php"><i class="fas fa-shopping-cart"></i>Cart</a></li>
